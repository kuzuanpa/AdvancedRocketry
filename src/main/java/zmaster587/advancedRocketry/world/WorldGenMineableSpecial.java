...
public class WorldGenMineableSpecial extends WorldGenerator {
    ...
    public WorldGenMineableSpecial(Block p_i45459_1_, int p_i45459_2_)
    {
    ...
    public WorldGenMineableSpecial(Block block, int meta, int number, Block target)
    {
                    ...
                    for (int l2 = j1; l2 <= i2; ++l2)
                    {
                        ...
                        if (d12 * d12 + d13 * d13 < 1.0D)
                        {
                            for (int i3 = k1; i3 <= j2; ++i3)
                            {
                                ...
                                {
                                	BlocksGT.ore.placeBlock(p_76484_1_, k2, l2, i3, (byte)6, (short)mineableBlockMeta, null, false, true);
                                }
                            }
                        }
                    }
