...
public class GenLayerEdgeExtendedBiomes extends GenLayerExtendedCompare {

	public GenLayerEdgeExtendedBiomes(long p_i45475_1_, GenLayer p_i45475_3_) {
        super(p_i45475_1_);
    ...
    private boolean func_151634_b(int biomeA, int biomeB)
    {
        if (compareBiomesById(biomeA, biomeB))
        {
            return true;
        }
        else if (AdvancedRocketryBiomes.instance.getBiomeById(biomeA) != null && AdvancedRocketryBiomes.instance.getBiomeById(biomeB) != null)
        {
            BiomeGenBase.TempCategory tempcategory = AdvancedRocketryBiomes.instance.getBiomeById(biomeA).getTempCategory();
            BiomeGenBase.TempCategory tempcategory1 = AdvancedRocketryBiomes.instance.getBiomeById(biomeB).getTempCategory();
