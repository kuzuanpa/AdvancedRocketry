...
public interface IDataHandler {
	 ...
	 */
    int extractData(int maxAmount, DataStorage.DataType type, ForgeDirection dir, boolean commit);
	 ...
	 */
    int addData(int maxAmount, DataStorage.DataType type, ForgeDirection dir, boolean commit);
