...
public interface ISpaceObject {
	...
	double getRotation(ForgeDirection dir);
	double getDeltaRotation(ForgeDirection dir);
	
	void setRotation(double rotation, ForgeDirection dir);
	
	double getMaxRotationalAcceleration();
	
	void setDeltaRotation(double rotation, ForgeDirection dir);
	 ...
	 */
    BlockPosition getNextLandingPad(boolean commit);
