...
public class ItemAstroBed extends Item {
     ...
     */
    public boolean onItemUse(@NotNull ItemStack p_77648_1_, EntityPlayer p_77648_2_, World p_77648_3_, int p_77648_4_, int p_77648_5_, int p_77648_6_, int p_77648_7_, float p_77648_8_, float p_77648_9_, float p_77648_10_)
    {
        ...
        {
            ++p_77648_5_;
            BlockBed blockbed = (BlockBed)AdvancedRocketryBlocks.blockAstroBed;
