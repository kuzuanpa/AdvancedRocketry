...
public class ItemBlockWithIcon extends Item {
     ...
     */
    public boolean onItemUse(ItemStack stack, EntityPlayer player, @NotNull World world, int x, int y, int z, int p_77648_7_, float p_77648_8_, float p_77648_9_, float p_77648_10_)
    {
