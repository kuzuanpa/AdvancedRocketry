...
public class BlockCrystal extends Block implements INamedMetaBlock {
    ...
    @SideOnly(Side.CLIENT)
    public boolean shouldSideBeRendered(@NotNull IBlockAccess world, int x, int y, int z, int side)
    {
        ...
        return (block != this || blockMeta != thisBlockMeta) && super.shouldSideBeRendered(world, x, y, z, side);
